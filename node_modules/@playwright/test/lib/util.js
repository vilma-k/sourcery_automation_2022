...
exports.filterUndefinedFixtures = filterUndefinedFixtures;
...
function filterUndefinedFixtures(o) {
  ...
  return Object.fromEntries(Object.entries(o || {}).filter(entry => !Object.is(entry[1], undefined)));
}
...
async function normalizeAndSaveAttachment(outputPath, name, options = {}) {
  ...
  if (options.path !== undefined) {
    ...
    const dest = _path.default.join(outputPath, 'attachments', hash + _path.default.extname(options.path));
